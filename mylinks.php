<?php
	...
	?>
					<tr id="links_tr">
						...
						<td id="link_td_links"><a href="visit.php?id=<?php echo $temp->lid."&sid=".$sid;?>" title="Ver link"><img src="images/link.png" title="Link LaMantengo" alt="Link LaMantengo" /></a></td>
						<td id="desc_td_links"><?php echo $temp->description; ?></td>
						<td id="visits_td_links"><?php echo $temp->visits; ?></td>
						<td id="edit_td_links"><a href="?action=edit&lid=<?php echo $temp->lid."&sid=$sid"; ?>" title="Editar"><img src="images/edit.png" alt="Editar" title="Editar" /></a></td>
						<td id="delete_td_links"><a href="?action=delete&lid=<?php echo $temp->lid."&sid=$sid"; ?>" title="Eliminar"><img src="images/delete.png" alt="Eliminar" title="Eliminar" /></a></td>
	...
	?>
		...
		<div id="explicacion">
			Clickee el bot&oacute;n <img src="images/edit.png" alt="Editar" title="Editar" /> a la derecha de un link para cambiar el destino del mismo, o bien <img src="images/delete.png" alt="Eliminar" title="Eliminar" /> para desactivarlo permanentemente.<br />
