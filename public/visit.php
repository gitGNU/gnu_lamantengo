				...
				<tr id="tr_contenido_visit">
					<td id="frame_visit">
						<div id="panel_visit">
							<div id="links_visit">
								<div id="logo_visit">
									<a href="index.php" title="Ir a LaMantengo.Com.Ar" id="logo_link_visit"><img src="<?php echo IMAGE_PATH . DS; ?>logo-visit.png" alt="Logo LaMantengo.Com.Ar" /></a></div>
								</div>
								<div id="cp_visit">
									<a href="<?php echo $temp->destination;?>" title="Quitar marco"><img src="<?php echo IMAGE_PATH . DS; ?>cross.png" alt="Quitar marco" /></a><br />
									<?php if($owns) { ?>
