<?php
	...
	?>
			...
			?>
				...
				<tr id="imglink">
					<td colspan="2" align="center" id="imglink">
						<a href="mylinks.php?action=edit&lid=<?php echo $id."&sid=".$sid;?>" id="imglink" title="Editar"><img src="images/edit.png" id="imglink" /> Editar</a>
						<a href="mylinks.php?action=delete&lid=<?php echo $id."&sid=".$sid;?>" title="Eliminar" id="imglink"><img src="images/delete.png" id="imglink" /> Eliminar</a>
					</td>
				</tr>
			<?php
		}
		...
		<div id="explicacion">
			...
			Para ello, pulse los botones <img src="images/edit.png" alt="Editar" title="Editar"> o <img src="images/delete.png" alt="Eliminar" title="Eliminar" />, respectivamente.
		</div>
	<?php
	}
	echo "</div>";
